...
export function Navbar() {
    ...
    const navLinks = [
        ...
        { name: "Quiénes Somos", href: isHome ? "#quienes-somos" : "/#quienes-somos" },
        { name: "Servicios", href: isHome ? "#servicios" : "/#servicios" },
        { name: "Productos", href: isHome ? "#productos" : "/#productos" },
        { name: "Sustentabilidad", href: isHome ? "#sustentabilidad" : "/#sustentabilidad" },
        { name: "Clientes", href: isHome ? "#clientes" : "/#clientes" },
        { name: "Blog", href: "/blog" },
    ...
    return (
        <nav
            className={cn(
                ...
                scrolled || !isHome ? "bg-white/95 backdrop-blur-sm shadow-md py-2" : "bg-transparent py-6"
            )}
        >
            <div className="container mx-auto px-4 flex justify-between items-center">
                <Link href="/" className="flex items-center gap-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div className={cn("h-10 w-px transition-colors duration-300", scrolled || !isHome ? "bg-slate-900" : "bg-white")}></div>
                        <div className={cn("flex flex-col text-sm font-bold leading-tight transition-colors duration-300", scrolled || !isHome ? "text-slate-900" : "text-white")}>
                            <span>COMERCIAL</span>
                ...
                {/* Mobile Menu Button */}
                <button
                    className={cn("lg:hidden", scrolled || !isHome ? "text-slate-900" : "text-white")}
